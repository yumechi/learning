...
== チーム開発におけるコミュニケーションの取り方

業務でシステム開発するとなると個人で開発するケースもあるかとは思いますが、多くはチーム開発になるでしょう。そこで避けては通れないのが、チームメンバーとのコミュニケーションです。このコミュニケーションは大きく次の3つに別れると思います。
...
それぞれのパターンにおいて私が経験してきた気をつけるべきポイントと、どうすれば良いのかを紹介していきたい思います。

=== コミュニケーションの取り方の原則

まず前提としてどのパターンでも通じる原則があります。それは謙虚（Humility）、尊敬（Respect）、信頼（Trust）の3つの精神です。これはHRT(ハート)と呼ばれ、Team GeekというGoogleでリーダーを務めたITエンジニアが書いた本に登場した概念です。それぞれ次の様な概念となっています。
...
他にも否定から入るのが口癖のようになってしまっている人もいると思います。メンバーから何か言われた時に「いや、それは・・・」とか、「そうじゃなくて、これは・・・」とかのように喋ってしまうケースです。この様な言動を繰り返しているとメンバーは何を言っても否定されると思い、そのうち何も言わなくなってしまいます。もし心当たりがある人は「確かにそうですね。でも他の可能性として・・・」の様に言い換えることを意識してみると良いでしょう。
...
一つ前の話の防止策にもなるのですが、メンバーに対して何かしらの指摘をする際はコード、設計書、テスト結果などのエビデンスを用意しましょう。なぜならば、その指摘内容に誤りがあると謝罪が必要になり、うまく謝罪できないとメンバーの不信感につながります。そのため、指摘する前にエビデンスを用意してから指摘しましょう。もし会話の最中などで気づいた場合は「確認したい点がある」と言って一緒にエビデンスを確認してから指摘するようにしましょう。
...
またメンバーによっては実装中のコードを見られたくないという人もいました。レビューはどうするのか?と聞くと我慢していると言っていたので、コードを見られるのが嫌という人もいるようです(正直チーム開発に向いてないんじゃないかと思いましたが、まぁそういう人もいるということでしょう)
...
リーダーとはいえ人間です。当然たまにはミスや間違いを犯します。前に挙げたリーダーからメンバーへのコミュニケーションの内容についても、同じ様な不満を覚えた方もいらっしゃるでしょう。

そのときはできるだけリーダーに直接フィードバックしましょう。大体の場合、リーダーはメンバーより年上や経験が豊富な方がつくことが多いので、何か進言するのは憚られる、言いづらいから気が進まないとは思いますが、ここで言いやすいからと第三者を通してもデメリットはあれどあまりメリットはありません。例えば次の様なデメリットがあります。
...
また、第三者は公平な立場に立とうとするのでメンバーから言われたことを鵜呑みにせず、リーダーにも事情を聞こうとします。この時点でリーダーに対して会話する時間を調整し会話しと時間がかかってしいます。直接会話すれば5分で解決するかもしれない話が、1時間、2時間とかかり、かつ、買い付けにも時間を要してしまい、チームのアジリティが下がります。
...
チームのためにフィードバックしてほしいと書きましたが、リーダーによっては独善的で改善する気持ちがなく、またはハラスメントをするようなタイプの人もいるでしょう。そういったリーダーに対してまで直接フィードバックするべきとは言いません。なによりまず自分を守るのが大事です。チームはその後です。次の様なリーダーからはチーム外の第三者を頼ってでも抜け出した方がいいでしょう。
...
メンバー同士のコミュニケーションでありがちなのが、知らず知らずのうちに相手の地雷を踏み抜いていたということがあります。自分は問題ない言葉、語句、表現、やり方だったとしても相手には問題がある可能性があります。そのため、コミュニケーションを取る際には言葉遣いに気をつけた方がいいでしょう。例えば次の様なことは要注意です。

...
現代は大量の情報が流通していて、その中に多くの言語化された学びがある。ブログや本、同人誌は、それらの典型的な形だ。学びを読者に伝えるための物だ。今この本を手に取っている読者は、まさに言語化された学びを読んでいて、ここから何かを学んで自己変容を遂げようとしているのだ。あるいはもう既に自己変容した後だろうか。
...
次に、その情報を自分の中でかみ砕いて整理する過程で、より意識的な言語化が行われる。「なるほど、これはこういう意味を持つのか」「これには共通点があるな」といった具合に、インプットしたものからの気づきを言葉にするのだ。そのとき、既存の知識と結びつけることで、より深い理解が生まれる。
...
このように言語化とは、漠然とした思考を、意識的に整理・構造化し、他者と共有可能な形に表現するプロセスなのだ。
...
指示書からは、書いた当時の経験、思想そういったものは失われやすい。なぜこういう形の指示にしたのか？なぜこういう形の指示にしなかったのか？選択肢が複数あるとき、どうしてこれを選んだのか？当時はおそらく根拠があったはずだ。経験、知識、意思決定の基準そういったものだ。これらは単なる指示書からは読み取りづらいものだ。だからこそ人間が読み書きしやすい言葉で、失われやすい情報を書き記しておくべきなのだ。

...
//embed{
    \clearpage
    \includepdf[pages=2,pagecommand={\thispagestyle{plainhead}}]{images/chap-fumiyasac-note/output_note_input.pdf}
	\includepdf[pages=9,pagecommand={\thispagestyle{plainhead}}]{images/chap-fumiyasac-note/output_note_input.pdf}
	\includepdf[pages=14,pagecommand={\thispagestyle{plainhead}}]{images/chap-fumiyasac-note/output_note_input.pdf}
//}

...
ここまでで言語化と学びのプロセスについて掘り下げてきた。この章では実践的な話として学びをhackしていく方法をまとめた。
...
何かを学ぼうとするとき、最初の一歩として概略をつかむことが重要だ。全く何も分かっていない状態では、その学びの難しさや分量、得られるものすら把握できない。プログラミングができない人がPythonを覚えたい、みたいな時がこの状況だ。概略さえつかめば、どれくらいのスケール感なのか、どの程度の時間や労力が必要なのかが見えてくる。
...
概略を掴んだ後は、その全体像を適切なサイズに分割していく。Pythonの学習なら「文法」「開発環境」「ライブラリ」といった要素に分解できる。さらに文法であれば「変数」「制御構文」「関数」というように細分化していける。
...
未知の領域に挑戦するとき、最初は完全な正解を求める必要はない。むしろ、あえて大雑把な推測、つまり「あたり」をつけることが重要だ。あたりは、最初は完全に的外れかもしれない。しかし、それは問題ではない。

なぜなら、あたりが一種の基準点となり、そこからの学びによって理解がどう変化したのかが明確になるからだ。たとえば新しい技術について「これは多分データベースに似たものかな」と考えたとする。学びが進むにつれ、その推測が正しかったのか、あるいはどう違っていたのかが分かってくる。何も考えずに始めるよりは、あたりとの差分がどうだったかを考えた方がギャップが小さい。
...
プログラミングにおいて初心者によくお勧めされるのが写経である。本に書いてあるソースコードなどを、実際にタイピングして動かすというものだ。写経の効能には賛否両論あるが、そのコードを元に積極的に好奇心を発露してみるならありだというのが筆者の考え方である。

既存のコードを見たとき、ある部分を書き換えてみたくなる。そこで実際に変更を加えてみると、予想通りの結果になることもあれば、思いもよらない動作になることもある。そのような予想と結果のギャップこそが、新しい理解への入り口となる。

このようにプログラミングの世界では、この好奇心駆動型の学びが特に効果的だ。

ウェブフロントエンドなんかは、好奇心に基づいて学びやすいものだ。有名なウェブサイトの構造を真似る練習をしてみるといい。HTML/CSSをどう書けば、有名なウェブサイトと同じに見えるようになるか？試行錯誤を繰り返すのだ。手元で練習する分には、単なるコピーでもいい。そこから何を削ったら崩れるか？何を書き換えればどう変わるか？を気が赴くまま、思いつく限り試すのだ。これはウェブサイトのコーディング力の底上げに役立つ。
